    ...
    <main id="main" class="data-security-page">
      <div class="container data-security-content">
        <div class="data-security-images">
          <img src="/assets/images/data-security-hero.jpg" alt="Data security" loading="lazy">
          <figure>
            <img src="/assets/images/iso-27001-small.jpg" alt="ISO 27001 and UKAS certification" loading="lazy">
...
const aecArchiveServices = [...aecArchiveSeedPages.flat(), ...aecArchiveAdditionalRows].map(([title, href, date, author, image, excerpt]) => ({
  title,
  href,
  date,
  author,
